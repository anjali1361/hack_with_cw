...
//                page.setScaleY(0.8f + r * 0.2f);
        ...
        skip.setOnClickListener(v -> {
            ...
            Toast.makeText(bitsindri.hncc.collegeapp.activities.IntroQuestion.this, "skip", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(bitsindri.hncc.collegeapp.activities.IntroQuestion.this,MainActivity.class));
            finish();
