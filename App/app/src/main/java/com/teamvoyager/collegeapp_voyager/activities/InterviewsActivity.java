...
public class InterviewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interviewsRecyclerView.setLayoutManager(new LinearLayoutManager(bitsindri.hncc.collegeapp.activities.InterviewsActivity.this));
        ...
        interviewsAdapter = new homeFeedAdapter(interviewsList, bitsindri.hncc.collegeapp.activities.InterviewsActivity.this);
