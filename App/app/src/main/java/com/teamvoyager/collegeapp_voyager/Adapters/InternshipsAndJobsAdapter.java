...
public class InternshipsAndJobsAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        bitsindri.hncc.collegeapp.Adapters.InternshipsAndJobsAdapter.InternshipsAndJobsHolder InternshipsAndJobsHolder = (bitsindri.hncc.collegeapp.Adapters.InternshipsAndJobsAdapter.InternshipsAndJobsHolder)holder;
